...
[![Currículo](https://img.shields.io/badge/Currículo-000000?style=for-the-badge&logo=read-the-docs&logoColor=white)](./cv-vinicius-pina-ferreira.pdf)
...
* **Habilidades Técnicas:** Python, Javascript, SQL, AWS.
...
| **Modularização** | Separação do código em funções independentes para facilitar manutenção, leitura e reutilização. | [Ver Projeto](./projeto-modularização/) |
...
- `/projeto-engenharia-de-soluções-logicas/`: Decomposição e resolução de problemas complexos.  
- `/projeto-modularização/`: Organização de código em funções independentes.  
